      ...
      <div>
        <div className="Container ">
              ...
              <div className='column'>
                ...
                <div class="container">
                  <div class="notification">
                    ...
                    <center><h1 className="title is-1">IPv6 Calculator</h1></center>
                    <br></br>
                    <input 
          ...
          defaultValue={this.state.value}>
            ...
            <br></br>
            <br></br>
            <button className= 'button is-warning is-medium ' onClick={this.handleClick} 
            onClick={this._Calculator}>Calculator</button>
                    <center>
